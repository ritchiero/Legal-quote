        ...
        <div className="px-8 pt-7 pb-8 space-y-6">
          ...
          {!showEmailSignIn && !showSignUp && (
            <div className="space-y-5">
              ...
              {/* Google button — white bg, colorful Google logo */}
              <button
                onClick={handleGoogleSignIn}
                disabled={isGoogleSignInLoading}
                className="flex items-center justify-center w-full px-6 py-3.5 font-semibold text-[14px] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[#F8FAFF] hover:-translate-y-[1px]"
                style={{
                  color: '#0B0F1A',
                  background: '#FFFFFF',
                  borderRadius: '9999px',
              ...
              >
                {isGoogleSignInLoading ? (
                  <div className="w-5 h-5 mr-3 border-2 border-[#3C65E2]/30 border-t-[#3C65E2] rounded-full animate-spin" />
                ) : (
                  <svg className="mr-3 flex-shrink-0" style={{ width: '20px', height: '20px' }} viewBox="0 0 24 24">
              ...
              >
                <svg
                  ...
                  stroke="currentColor"
                  strokeWidth={1.5}
                  style={{ width: '18px', height: '18px', marginRight: '10px', color: '#7C86A4' }}
                >
