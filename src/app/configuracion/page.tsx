  ...
  return (
        <div className="w-full mx-auto px-4 box-border max-w-full bg-[#F5F6F8] min-h-screen font-jakarta">
              <div className="md:hidden sticky top-16 z-10 bg-white border-b border-gray-200 py-3">
                      <h1 className="text-lg font-semibold text-[#0E162F] text-center">Configurador de Cotizador con IA</h1>h1>
              </div>div>
        
              <div className="flex flex-col items-center">
                      <h1 className="hidden md:block text-[18px] font-bold text-[#0E162F] mb-2 text-center mt-8">Configurador de Cotizador con IA</h1>h1>
                      <p className="hidden md:block text-[16px] text-[#3B3D45] mb-3 text-center">Configura estas opciones para automatizar tus cotizaciones.</p>p>
          ...
          { label: 'Facturacion', Icon: DocumentTextIcon },
          { label: 'Pago', Icon: CreditCardIcon },
          { label: 'Branding', Icon: SparklesIcon },
          { label: 'Configuracion', Icon: Cog6ToothIcon },
                      ].map(({ label, Icon }) => (
                                      <button
                                                        key={label}
                      ...
                      <div className="w-full text-center py-12">
                                    <h2 className="text-[18px] font-bold text-[#0E162F] mb-4">Sube tu primer proyecto</h2>h2>
                                    <p className="text-[16px] text-[#3B3D45] mb-6">
                                                    Muestra tu mejor trabajo. Recibe retroalimentacion y se parte de una comunidad en crecimiento.
                                    </p>p>
